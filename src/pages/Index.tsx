      ...
      {!showServices ? (
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute top-40 right-20 w-48 h-48 bg-primary/20 rounded-full blur-3xl animate-float-slow" />
            <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-secondary/15 rounded-full blur-2xl animate-float" style={{ animationDelay: '2s' }} />
            <div className="absolute top-1/3 right-1/3 w-24 h-24 bg-accent/20 rounded-full blur-xl animate-float-slow" style={{ animationDelay: '1s' }} />
            
            <div className="absolute top-1/4 left-1/2 w-2 h-2 bg-white/60 rounded-full animate-float" style={{ animationDelay: '0.5s' }} />
            <div className="absolute top-1/2 left-1/4 w-3 h-3 bg-white/50 rounded-full animate-float-slow" style={{ animationDelay: '1.5s' }} />
            <div className="absolute bottom-1/3 right-1/4 w-2 h-2 bg-white/70 rounded-full animate-float" style={{ animationDelay: '3s' }} />
            <div className="absolute top-2/3 right-1/3 w-3 h-3 bg-white/40 rounded-full animate-float-slow" style={{ animationDelay: '2.5s' }} />
            
            <svg className="absolute top-1/4 right-1/4 w-24 h-24 text-white/10 animate-float" style={{ animationDelay: '1s' }} viewBox="0 0 100 100">
              <polygon points="50,15 90,85 10,85" fill="currentColor" />
            </svg>
            <svg className="absolute bottom-1/4 left-1/3 w-32 h-32 text-primary/10 animate-float-slow" style={{ animationDelay: '2s' }} viewBox="0 0 100 100">
              <rect x="10" y="10" width="80" height="80" fill="currentColor" transform="rotate(45 50 50)" />
            </svg>
            <svg className="absolute top-1/2 left-10 w-20 h-20 text-secondary/15 animate-float" style={{ animationDelay: '3s' }} viewBox="0 0 100 100">
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-br from-background via-primary/5 to-secondary/10">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-10 right-10 w-40 h-40 bg-primary/10 rounded-full blur-3xl animate-float-slow" />
            ...
            <div className="absolute top-1/2 right-1/4 w-32 h-32 bg-accent/10 rounded-full blur-2xl animate-float-slow" style={{ animationDelay: '2s' }} />
            
            <svg className="absolute top-1/3 left-1/4 w-28 h-28 text-primary/5 animate-float" style={{ animationDelay: '0.5s' }} viewBox="0 0 100 100">
              <polygon points="50,15 90,85 10,85" fill="currentColor" />
            </svg>
            <svg className="absolute bottom-1/3 right-1/3 w-24 h-24 text-secondary/5 animate-float-slow" style={{ animationDelay: '1.5s' }} viewBox="0 0 100 100">
              <rect x="10" y="10" width="80" height="80" fill="currentColor" transform="rotate(45 50 50)" />
            </svg>
          </div>
